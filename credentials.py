...
couch = cb.Server("http://advait123:advait123@localhost:5985/")
dbname = "tweets"
if dbname in couch:
    db = couch[dbname]
else:
...
SEARCH_QUERY_STRING = "#work"
auth = tw.OAuthHandler(APP_KEY, APP_SECRET)
data = {}
api = tw.API(auth)
since_date = "2015-01-01"
data = api.search(q=SEARCH_QUERY_STRING, since_id=since_date, lang="en",geocode="37.8136,144.9631,1000km",tweet_mode='extended',count=100)
# print(data)
for i in data:
    # print("\n",i.retweet_count,"\n")
